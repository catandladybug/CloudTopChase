...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        public void AddSoldiers()
        {
            ...
            totalNumSoldiers = totalNumSoldiers + 100;
            totalSoldiers.text = "Total: " + totalNumSoldiers;
        ...
        {
            numberOfSoldiers = 50;
            totalNumSoldiers = totalNumSoldiers + 50;
            totalSoldiers.text = "Total: " + totalNumSoldiers;
